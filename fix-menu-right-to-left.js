/**
 * fix-menu-rtl.js
 * סקריפט להחלפת התפריט בכל הדפים לתפריט מימין לשמאל
 */

const fs = require('fs');
const path = require('path');

console.log('=== החלפת התפריט בכל הדפים לתפריט מימין לשמאל ===');
...
// תוכן קובץ navigation.js המעודכן עם סדר מימין לשמאל
const navigationJsContent = `// navigation.js - קובץ לניהול תפריט הניווט בכל הדפים
// גרסה סופית - מציג את התפריט המבוקש מימין לשמאל
...
function createFixedNavigation() {
    ...
    // יצירת התפריט הקבוע המבוקש - סדר מימין לשמאל
    const links = [
...
console.log('✅ נוצר קובץ navigation.js עם התפריט מימין לשמאל');
