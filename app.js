...
function showConfirm(message, opts = {}) {
    ...
    return new Promise((resolve) => {
        ...
        modal.innerHTML = `
            <div class="modal" style="max-width:400px;text-align:center;border-radius:16px !important;animation:none !important;margin:auto;padding:28px 24px">
    ...
    modal.innerHTML = `
        <div class="modal" style="max-width:380px;text-align:center;border-radius:16px !important;animation:none !important;margin:auto">
            ...
            <div style="display:flex;gap:10px;justify-content:center">
                <button class="btn btn-primary" id="confirmLogoutBtn" style="min-width:120px;justify-content:center">${ICONS.logout}<span>כן, התנתק</span></button>
                <button class="btn btn-danger" id="cancelLogoutBtn" style="min-width:120px;justify-content:center">${ICONS.close}<span>יציאה</span></button>
            </div>
        </div>
    `;
    document.body.appendChild(modal);
